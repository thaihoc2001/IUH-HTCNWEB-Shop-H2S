...
$(document).ready(function (){
    $.getJSON("../../../js/data.json", function (data) {
        ...
        renderProdcut();
        data1 = dataProducts.filter(function (item) {
            return item.classify == "adidas"
        })
        console.log(data1)
        data2 = dataProducts.filter(function (item) {
            return item.classify == "converse"
        })
        data3 = dataProducts.filter(function (item) {
            return item.classify == "mlb"
        })
        data4 = dataProducts.filter(function (item) {
            return item.classify == "vans"
        })
        data5 = dataProducts.filter(function (item) {
            return item.classify == "nike"
        })
        data6 = dataProducts.filter(function (item) {
            return item.price < 1000000;
        })
        data7 = dataProducts.filter(function (item) {
            return item.price > 1000000 && item.price < 3000000;
        })
        data8 = dataProducts.filter(function (item) {
            return item.price > 3000000 && item.price < 5000000;
        })
        data9 = dataProducts.filter(function (item) {
